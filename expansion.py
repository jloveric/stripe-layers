...
class PiecewisePolynomialSharedFullyConnected(PiecewiseShared):
    def __init__(self, n, in_channels, segments, length=2.0, weight_magnitude=1.0, periodicity: float = None, device='cuda', ** kwargs):
        super().__init__(n, in_channels, segments,
                         length, weight_magnitude, poly=LagrangePolySharedFullyConnected, periodicity=periodicity, device=device)
