    ...
    def __init__(self, cfg: DictConfig):
        ...
        self.layer1 = StripeLayer2d(
            layer_creator=fully_connected_stripe(
                n=n, in_channels=3, in_elements=1024, out_features=cfg.out_features, segments=cfg.segments, periodicity=cfg.periodicity),
            height=32,
            width=32,
...
@hydra.main(config_name="./config/cifar100invariant_config")
