...
class StripeLayer2d(torch.nn.Module):
    def __init__(
        self,
        layer_creator: Callable[[], torch.nn.Module],
        width: int,
        height: int,
        rotations: int = 1,
        device="cuda",
        ...
        self.positions = create_stripe_list(width, height, rotations, device=device)
